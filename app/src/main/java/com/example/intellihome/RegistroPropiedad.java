...
public class RegistroPropiedad extends AppCompatActivity {
    ...
    private void registrarPropiedad() {
        ...
        if (TextUtils.isEmpty(nombrePropiedad) || TextUtils.isEmpty(cantidadPersonasStr) || TextUtils.isEmpty(cantidadHabitacionesStr)
                || TextUtils.isEmpty(precio) || TextUtils.isEmpty(ubicacion) || TextUtils.isEmpty(amenidadesCasa)) {
        ...
        // Crear un objeto Propiedad con los datos
        String idPropiedad = databaseReference.push().getKey();
        Propiedad propiedad = new Propiedad(idPropiedad, nombrePropiedad, cantidadPersonas, cantidadHabitaciones, precio, ubicacion, amenidadesCasa);

        // Guardar la propiedad en Firebase
        if (idPropiedad != null) {
            databaseReference.child(idPropiedad).setValue(propiedad).addOnCompleteListener(task -> {
    ...
    public static class Propiedad {
        ...
        public Propiedad(String idPropiedad, String nombrePropiedad, int cantidadPersonas, int cantidadHabitaciones, String precio, String ubicacion, String amenidadesCasa) {
